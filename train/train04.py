...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', '--model', dest='model', default="train04_ja_unigram.model", help='input model data')
    parser.add_argument('-t', '--test', dest='test', default="../data/wiki-ja-test.txt", help='input test data')
    parser.add_argument('-s', '--result', dest='result', default="train04.result", help='writeing result file')
